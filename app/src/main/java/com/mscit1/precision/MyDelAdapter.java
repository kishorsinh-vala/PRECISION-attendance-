...
class MyDelAdapter extends BaseAdapter {
    Context con;
    ArrayList<HashMap<String,Object>> list;
    LayoutInflater li;
    public MyDelAdapter(DeleteStud deleteStud, ArrayList<HashMap<String, Object>> array) {
        con=deleteStud;
        list=array;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = li.inflate(R.layout.delete_adapter,
                null);
